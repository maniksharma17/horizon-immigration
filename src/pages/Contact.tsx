...
const Contact = () => {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      setIsLoading(true);
      const url =
        'https://script.google.com/macros/s/AKfycbyGoV3kIxEndacunf7CP_94XZ0R0H6U6dbGB-aiQ1yJg_ppuOqcyKase8E15rbUlp5k/exec';
      await fetch(url, {
        method: 'POST',
              ...
              <div className="flex flex-col justify-center max-md:flex-col gap-2">
                <div className="text-left bg-white/90 border p-4 overflow-x-clip rounded-lg shadow-lg">
                  ...
                  <Button variant="outline" className="mt-2">
                    <a href="mailto:team@immigrationhorizon.com?body=Hello">Send Mail</a>
                  </Button>
                </div>

                <div className="text-left bg-white/90 border p-4 overflow-x-clip rounded-lg shadow-lg">
                  <img
                    src="/WhatsappMenuIcon.svg"
                    className="h-8 w-8 mx-auto mb-4 text-primary inline mt-1 mr-2"
                    alt="Whatsapp Icon"
                  />
                  ...
                  <Button variant="outline" className="mt-2">
                    <a href="https://wa.me/+919528387189">Send Message</a>
                  </Button>
                </div>

                <Button variant="outline" className="mt-2 w-fit p-4 shadow-lg flex justify-start">
                  <a href="https://www.instagram.com/horizon_immigration1/" className="flex flex-row gap-2 items-center">
                    <img src="/InstagramMenuIcon.svg" className="w-7 h-7" alt="Instagram Icon" />
                    <span>Follow on Instagram</span>
                  </a>
                </Button>

                <Button variant="outline" className="w-fit p-4 shadow-lg flex justify-start">
                  <a href="https://www.facebook.com/share/19hbgqrYsi/?mibextid=wwXIfr" className="flex flex-row gap-2 items-center">
                    <img src="/FacebookMenuIcon.svg" className="w-6 h-6" alt="Facebook Icon" />
                    <span>Connect on Facebook</span>
                  </a>
                </Button>

                <Button variant="outline" className="w-fit p-4 shadow-lg flex justify-start">
                  <a href="https://www.youtube.com/@horizon_immigration1" className="flex flex-row gap-2 items-center">
                    <img src="/YoutubeMenuIcon.svg" className="w-6 h-6" alt="Youtube Icon" />
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Button
                type="submit"
                disabled={isLoading}
                className="md:col-span-2 bg-gradient-to-b from-accent to-orange-700"
              >
